...
type: entity
status: canon
description: The Recurring Agent. Appears across centuries. Manifests differently for every person who meets them. Identified by signatures, never by features.
---

# Seven

No badge number — or rather, the number that doesn't fit the system. Field reports list them as **S—**, **Subject 7**, or just **7**. The designation is older than the current numbering scheme. Older than most of the current scheme, period.

Seven shows up. Serves a tour. Disappears. The pattern is in the records as far back as the records go.
...
- **No name.** Or a different name each time. Or "you already know."
- **Unusual presence.** The festival drops 10dB for a minute. Afterward you can't quite reconstruct what they looked like — only what it felt like to be there.
- **The parting line.** Seven says *"see you again"* on the way out. You can't tell if you've met them before, or if you ever will.
...
See [[who-is-seven]]. Field doctrine: don't resolve it. The mystery is load-bearing.
